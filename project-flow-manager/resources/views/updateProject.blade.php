            ...
            <div class="card-body p-4" >
              <div class="d-flex flex-column justify-content-center align-items-center">
                <div class="d-flex justify-content-evenly">
                    <h2 class="text-center text-success text-uppercase fw-bold">Update Project</h2>
                </div>
                ...
                <div class="mt-4">
                    <form action="" class="mx-auto" enctype="multipart/form-data" method="POST">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            ...
                            <input name="name" type="text" id="form4Example1" class="form-control" value="{{$project->name}}" />
                        </div>
                    
                        <!-- Description input -->
                        <div data-mdb-input-init class="form-outline mb-4">
                            <label class="form-label h5" for="form4Example3">Description</label>
                            <textarea name="description" class="form-control" id="form4Example3" rows="4">{{$project->description}}</textarea> 
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary h5">Update</button>
                        </div>
                    </form>
                </div>
              </div>
